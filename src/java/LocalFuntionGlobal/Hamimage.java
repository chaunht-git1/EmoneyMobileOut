...
// 
//        File folder = new File("C:\\Users\\TamChauDAMTC\\Pictures");
...
//              
//                BufferedImage originalImage   = ImageIO.read(new File("C:\\Users\\TamChauDAMTC\\Pictures\\"+listOfFiles[i].getName()));
//                tempPNG = resizeImage(originalImage,0,440,900);
//                tempJPG = resizeImage(originalImage,0,440,900);
//                // Doi hinh thanh String 
//               RenderedImage test=   bufferedImageTorenderedImage(tempJPG );
//               String testString=null;
//               testString=imgToBase64String(test, "jpg");
//               tempPNG=base64StringtoImg(testString);
//               System.out.println(testString);
//               String testString1;
//                
//               // Boolean kq=storeImageServer(tempJPG ,"test","win","imagetemp","jpg","CHAUNHT");
//
//              //  newFilePNG = new File("C:\\Users\\TamChauDAMTC\\Pictures\\Output\\"+listOfFiles[i].getName()+"_New.png");
//                //storeImageServer(originalImage, , i, null, null, null)
//             //   newFileJPG = new File("C:\\Users\\TamChauDAMTC\\Pictures\\Output\\"+listOfFiles[i].getName()+"_New1.jpg");
