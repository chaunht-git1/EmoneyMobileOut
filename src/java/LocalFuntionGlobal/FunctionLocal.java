...
//import DatabaseBean.DmBanklistDao;
import javax.persistence.EntityManager;
import javax.persistence.EntityManagerFactory;
import javax.persistence.Persistence;
import javax.persistence.Query;
import static ConnectBean.Provider.DADABASEKH;
...
//               String  maso = FunctionLocal.scanBarcode(originalImage);
    ...
    public static  Number laytygiatheongay(String idloaitien ,String idbank,Date ngaymax) {
        Number kq=null;
        ...
        try { 
          ...
          Query query = null;
          query=entitymanager.createQuery("SELECT v.tygia FROM VwTygiaListWeb v WHERE v.idCode=:idLoaitien AND v.idBank=:idBank AND v.dateModified=:ngayTao");
          query.setParameter("idLoaitien", idloaitien);
          query.setParameter("idBank", idbank);
          query.setParameter("ngayTao", ngaymax);
          kq = (Number) query.getSingleResult();
    ...
    public static  Number laytygiachitra(String idloaitien ,String idbank) {
        Date ngaymax=new Date();
        EntityManagerFactory emfactory = Persistence.createEntityManagerFactory(DADABASEVW);
        EntityManager entitymanager = emfactory.createEntityManager();

        try { 
          Query query = null;
          query=entitymanager.createQuery("SELECT MAX(v.dateModified) FROM VwTygiaListWeb v WHERE v.idCode=:idLoaitien AND v.idBank=:idBank");
          query.setParameter("idLoaitien", idloaitien);
          query.setParameter("idBank", idbank);
          ngaymax =(Date) query.getSingleResult();
          entitymanager.close();
          
          Number kq =FunctionLocal.laytygiatheongay(idloaitien,idbank,ngaymax);
...
//        
//       
//      // int type1 = originalImage.getType() == 0 ? BufferedImage.TYPE_BYTE_BINARY : originalImage.getType();
//         
...
//       
//       // BufferedImage blackiamge =new BufferedImage(Math.round(w*2/3),Math.round(h*2/3),originalImage.getType());
//       
...
//        if(w>1800){ 
//            
//      /* // blackiamge=fn.processImage(originalImage, 0, 20, 255, 250);   
//        BufferedImage resizedImage =new BufferedImage(  w , h ,originalImage.getType());
//        //BufferedImage resizedImage = new BufferedImage(w/2,h/2,blackiamge.getType());
//        Graphics2D g = resizedImage.createGraphics();
//        g.setBackground(Color.white);
//        g.drawImage(originalImage,0,0,resizedImage.getWidth(),resizedImage.getHeight(),null);
//        g.dispose();
//            */
//        BufferedImage resizedImage=Xulyimage.resizeImage(originalImage, originalImage.TYPE_INT_RGB, 440, 900);    
//        
//
//        return resizedImage;
//        }
...
//            Bean.SystemBean.proMessError(ex.getMessage());
            return 0;
     ...
     public static List<CityList> laydscity() {
            // Tạo entitymanager .
        ...
        try {
          Query query = null;
          query=entitymanager.createNamedQuery("CityList.findByIdValidity");
          query.setParameter("idValidity", "O");
        ...
        public static  List<GiaytoList> laydsgiayto() {
        List<GiaytoList> giaytolist = new ArrayList<>();
        EntityManagerFactory emfactory = Persistence.createEntityManagerFactory( "DatabaseKieuhoi" );
        EntityManager entitymanager = emfactory.createEntityManager();

        try { 
          Query query = null;
          query=entitymanager.createNamedQuery("GiaytoList.findByIdValidity");
          query.setParameter("idValidity", "O");
          giaytolist =query.getResultList();
          entitymanager.close();
          emfactory.close();
          return giaytolist;
        } catch (Exception e) {
   ...
   public static  List<DistrictList> dsquanhuyen(String idcity) throws SQLException {
        ...
        try { 
          Query query = null;
          query=entitymanager.createNamedQuery("DistrictList.findByIdCity");
          query.setParameter("idCity", idcity);
          dsquanhuyen =query.getResultList();
          entitymanager.close();
          emfactory.close();
          return dsquanhuyen;
        } catch (Exception e) {
     ...
     public static List<DmBankList> laydsbank() {
        List<DmBankList> dmbanklist = new ArrayList<>();
        EntityManagerFactory emfactory = Persistence.createEntityManagerFactory( "DatabaseKieuhoi" );
        EntityManager entitymanager = emfactory.createEntityManager();

        try { 
          Query query = null;
          query=entitymanager.createNamedQuery("DmBankList.findByIdValidity");
          query.setParameter("idValidity", "O");
          dmbanklist =query.getResultList();
          entitymanager.close();
          emfactory.close();
          return dmbanklist;
        } catch (Exception e) {
     ...
     public static List<VwDsNhnavienctWeb> laydsNVCHITRA(String dknv,String branch) {
        ...
        public static List<VwDoitacGpWeb> dsdoitacgiaophieu() {
        List<VwDoitacGpWeb> dmnvlist = new ArrayList<>();
        EntityManagerFactory emfactory = Persistence.createEntityManagerFactory(DADABASEVW);
        EntityManager entitymanager = emfactory.createEntityManager();

        try { 
          Query query = null;
          query=entitymanager.createNamedQuery("VwDoitacGpWeb.findAll");
          dmnvlist =query.getResultList();
          entitymanager.close();
          emfactory.close();
          return dmnvlist;
        ...
        public static  String nhanvienchitrafromqhuyen(String idcity ,String iddistric) {
        String kq=null;
        ...
        try { 
          Query query = null;
          query=entitymanager.createQuery("SELECT v.idNvChitra FROM DistrictList v WHERE v.idCity=:idCity AND v.idDistrict=:idDistrict");
          query.setParameter("idCity", idcity);
          query.setParameter("idDistrict", iddistric);
          kq =query.getSingleResult().toString();
          entitymanager.close();
          emfactory.close();
          return kq;
        } catch (Exception e) {
        ...
        public static VwDsNhnavienctWeb layttuserdangnhap(String user,String branch) {
         List<VwDsNhnavienctWeb> dsKq=new ArrayList<>();
         VwDsNhnavienctWeb  dmnv = new VwDsNhnavienctWeb();
        EntityManagerFactory emfactory = Persistence.createEntityManagerFactory( "DatabaseView" );
        EntityManager entitymanager = emfactory.createEntityManager();

        try { 
          Query query = null;
          query=entitymanager.createNamedQuery("VwDsNhnavienctWeb.findByUserVSBranch");
       ...
       public boolean xacnhanchitratam(VwDsUploadImagehbWeb imagehbWeb,String userid) throws SQLException{
         
          KieuhoiListPK kieuhoiListPK= new KieuhoiListPK();
          KieuhoiList kieuhoiList= new KieuhoiList();
         // kieuhoiListPK.setIdChinhanh(imagehbWeb.getIdChinhanh());
         // kieuhoiListPK.setSophieu(imagehbWeb.getSophieu().toString());
          //kieuhoiListPK.setStt(imagehbWeb.getStt());
          EntityManagerFactory emfactory = Persistence.createEntityManagerFactory(DADABASEKH);
          EntityManager entitymanager = emfactory.createEntityManager();
		...
		entitymanager.getTransaction().begin();
                kieuhoiList.setNgayBiennhan(new java.sql.Date(System.currentTimeMillis()));
                kieuhoiList.setIdNvBiennhan(userid);
                kieuhoiList.setBiennhan("Y");
                //kieuhoiList.setBiennhan("N");
                kieuhoiList.setGhichu("");
                Character c= imagehbWeb.getDachitrakt().charAt(0);
                kieuhoiList.setDachitra(c);
                kieuhoiList.setNgayChitraTrue(new java.sql.Date(System.currentTimeMillis()));
                kieuhoiList.setDachitratreo("Y");
                kieuhoiList.setNgayChitraCthang(imagehbWeb.getNgaychitratreo());
