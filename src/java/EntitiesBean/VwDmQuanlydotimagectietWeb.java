...
public class VwDmQuanlydotimagectietWeb implements Serializable {
    ...
    private String dkhoanthanh;
    
    private InputStream hinhbn;
    ...
    public String getDkhoanthanh() {
        return dkhoanthanh;
    }

    public void setDkhoanthanh(String dkhoanthanh) {
        this.dkhoanthanh = dkhoanthanh;
    }

    public InputStream getHinhbn() {
        return hinhbn;
    }

    public void setHinhbn(InputStream hinhbn) {
        this.hinhbn = hinhbn;
    }
