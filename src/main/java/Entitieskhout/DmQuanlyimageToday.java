...
@NamedQueries({
    ...
    , @NamedQuery(name = "DmQuanlyimageToday.findByFilepath", query = "SELECT d FROM DmQuanlyimageToday d WHERE d.filepath = :filepath")})
public class DmQuanlyimageToday implements Serializable {
    ...
    public String toString() {
        return "Entitieskhout.DmQuanlyimageToday[ khoa=" + khoa + " ]";
    }
